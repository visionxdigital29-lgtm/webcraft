          ...
          >
            ...
            <div className="relative mx-auto max-w-[650px]">
              ...
              >
                <div className="overflow-hidden rounded-[22px] border border-white/10 bg-[#06101f]">
                  <div className="flex h-11 items-center gap-2 border-b border-white/10 px-4">
                    ...
                    <div className="ml-auto hidden rounded-md border border-white/5 bg-white/[0.03] px-10 py-1 text-[8px] text-slate-600 sm:block">
                      webcraft.agency
                    </div>
                  </div>
                  ...
                  <div className="p-6 sm:p-9">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="hidden gap-5 text-[9px] text-slate-500 sm:flex">
                        <span>Home</span>
                        <span>Services</span>
                        <span>Portfolio</span>
                        <span>Contact</span>
                    ...
                    <div className="mt-14 grid items-center gap-8 sm:grid-cols-2">
                      <div>
                        <div className="mb-3 inline-flex items-center gap-1 text-[9px] font-semibold text-blue-400">
                          <Sparkles size={11} />
                          Digital Excellence
                        </div>
                        ...
                        <p className="text-2xl font-black leading-tight sm:text-3xl">
                          ...
                          <span className="text-blue-500">Drives Results</span>
                        </p>

                        <p className="mt-4 text-xs leading-5 text-slate-500">
                          Powerful websites designed to transform visitors into
                          customers.
                        </p>

                        <button className="mt-5 rounded-md bg-blue-600 px-4 py-2 text-[10px] font-bold">
                          Get Started
                        </button>
                      </div>
                      ...
                      <div className="relative flex h-52 items-center justify-center">
                        ...
                        <motion.div
                          ...
                          className="relative flex h-32 w-32 rotate-45 items-center justify-center rounded-3xl border border-blue-400/50 bg-gradient-to-br from-blue-500/30 to-cyan-400/5 shadow-[0_0_55px_rgba(59,130,246,.35)]"
                        >
                          <div className="flex h-16 w-16 items-center justify-center rounded-2xl border border-blue-300/50 bg-blue-500/20 shadow-[0_0_35px_rgba(59,130,246,.8)]">
                            <Code2
                              size={30}
                              className="-rotate-45 text-blue-200"
                            />
                          </div>
                        </motion.div>
                        ...
                        <motion.div
                          ...
                          className="absolute left-0 top-6 rounded-xl border border-white/10 bg-[#0c1729]/90 p-3 shadow-xl backdrop-blur-xl"
                        >
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              <p className="text-xs font-bold">99 Score</p>
                            </div>
                          </div>
                        </motion.div>
                        ...
                        <motion.div
                          ...
                          className="absolute bottom-4 right-0 rounded-xl border border-white/10 bg-[#0c1729]/90 p-3 shadow-xl backdrop-blur-xl"
                        >
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              <p className="text-xs font-bold">5.0 Stars</p>
                            </div>
                          </div>
                        </motion.div>
                      </div>
                    ...
                    <div className="mt-10 grid grid-cols-3 gap-3">
                      {[
                        ...
                        <div
                          key={item}
                          className="rounded-lg border border-white/5 bg-white/[0.03] p-3 text-center text-[8px] text-slate-400 sm:text-[9px]"
                        >
                          {item}
                        </div>
                      ))}
              ...
              >
                ...
                <p className="mt-9 text-sm font-black leading-5">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-slate-500">Responsive Design</p>
                    <p className="mt-1 text-sm font-bold">All Devices Ready</p>
                  </div>
                </div>
              </motion.div>
            </div>
